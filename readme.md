...
- [⬇️ **Download soyBean v1,0,0,1 Default Package**](https://github.com/artemis-env0/env.ZT/releases/download/v1.0.0.1/env0_soyBean_migrate_run_v1001.zip)
- [⬇️ **Download soyBean v1,0,0,0 Portable**](https://github.com/artemis-env0/env.ZT/releases/download/v1.0.0.1/env0_soyBean_migrate_full_v1001.py)
